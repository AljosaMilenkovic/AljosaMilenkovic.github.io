...
A unifying theme throughout my research projects is cumulativity in phonology, the combined effect of multiple phonological factors or multiple instances of a single factor on the well-formedness, probability, or acceptability of linguistic structures. For the past two decades, cumulativity has been a testing ground for competing constraint-based frameworks in phonology. My research on natural language prosody and metered verse shows that cumulative interactions are ubiquitous, as predicted by Harmonic Grammar, but not by [Optimality Theory](https://en.wikipedia.org/wiki/Optimality_theory).
...
<p align="center">
  ...
  <br>
  <em>Superlinear cumulativity: the effect of violating both constraints simultaneously is more detrimental than expected given their independent effects; the probability of doubly-violating structures is much lower than expected under the assumption of statistical independence.</em>
</p>
